...
<div id="main">
  ...
  <!-- <![endif]-->
  <div class="leftIndexContainer" id="LeftPane" runat="server"></div>
  <div class="indexContainer" id="ContentPane" runat="server"></div>
  <div class="rightIndexContainer" id="RightPane" runat="server"></div>
  <!--[if lte IE 9]>
  <div id="footer">
  <![endif]-->
  <!--[if !IE]> -->
